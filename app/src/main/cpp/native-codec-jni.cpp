...
jboolean Java_sample_com_frontcamerarecorder_ui_activities_VideoPreviewActivity_createStreamingMediaPlayer(
        JNIEnv *env,
        jclass clazz, jstring filepath) {
    LOGV("@@@ create");
    ...
    media_status_t err = AMediaExtractor_setDataSource(ex, utf8);
...
jboolean Java_sample_com_frontcamerarecorder_ui_activities_VideoPreviewActivity_createStreamingMediaPlayerFromAssets(
        JNIEnv *env,
...
void Java_sample_com_frontcamerarecorder_ui_activities_VideoPreviewActivity_setPlayingStreamingMediaPlayer(
        JNIEnv *env,
...
void Java_sample_com_frontcamerarecorder_ui_activities_VideoPreviewActivity_shutdown(JNIEnv *env,
                                                                                     jclass clazz) {
    LOGV("@@@ shutdown");
    if (mlooper) {
...
// set the surface
void Java_sample_com_frontcamerarecorder_ui_activities_VideoPreviewActivity_setSurface(JNIEnv *env,
                                                                                       jclass clazz,
                                                                                       jobject surface) {
...
void Java_sample_com_frontcamerarecorder_ui_activities_VideoPreviewActivity_rewindStreamingMediaPlayer(
